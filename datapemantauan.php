...
<br><br>
<center>
    <h2> Data Pemantaun Covid19 Wilayah <?php echo $_POST['namawilayah'];?><br>
Pertanggal (isi DISINI) <br>
Nama Operator <?php echo $_POST['namaoperator'];?><br>
NIM <?php echo $_POST['nimmahasiswa'];?> </h2><hr>
<table>
   <h2></h2>
